...
public class StatisticsController {
    ...
    public ResultVo getTradingData(HttpSession session) {
        ...
        data.put("totalOrders", orderService.getTotalOrderCount());
        data.put("totalAmount", orderService.getTotalOrderAmount());

        data.put("totalCommission", orderService.getTotalCommissionAmount());

        data.put("currentMonthOrders", orderService.getCurrentMonthOrderCount());
        data.put("currentMonthAmount", orderService.getCurrentMonthOrderAmount());
