...
public class MessageModel implements Serializable {
    ...
    private Byte messageStatus; // 0:未读 1:已读
    ...
    public Byte getMessageStatus() { return messageStatus; }

    public void setMessageStatus(Byte messageStatus) { this.messageStatus = messageStatus; }
